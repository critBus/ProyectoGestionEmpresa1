...
public class UsuarioDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public final CollectionExpression rol;
	
	public UsuarioDetachedCriteria() {
		super(entidades.Usuario.class, entidades.UsuarioCriteria.class);
		id = new IntegerExpression("id", this.getDetachedCriteria());
		username = new StringExpression("username", this.getDetachedCriteria());
		password = new StringExpression("password", this.getDetachedCriteria());
		rol = new CollectionExpression("ORM_Rol", this.getDetachedCriteria());
	}
	
	public UsuarioDetachedCriteria(DetachedCriteria aDetachedCriteria) {
		super(aDetachedCriteria, entidades.UsuarioCriteria.class);
		id = new IntegerExpression("id", this.getDetachedCriteria());
		username = new StringExpression("username", this.getDetachedCriteria());
		password = new StringExpression("password", this.getDetachedCriteria());
		rol = new CollectionExpression("ORM_Rol", this.getDetachedCriteria());
	...
	public RolDetachedCriteria createRolCriteria() {
		return new RolDetachedCriteria(createCriteria("ORM_Rol"));
	}
